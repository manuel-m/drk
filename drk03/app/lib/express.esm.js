...
function callSiteToString(callSite) {
  var addSuffix = !0,
    fileLocation = callSiteFileLocation(callSite),
  ...
  if (!(callSite.isToplevel() || isConstructor)) {
    ...
    functionName
      ? (typeName &&
          0 !== functionName.indexOf(typeName) &&
          (line += typeName + '.'),
        (line += functionName),
        methodName &&
...
var compat = createCommonjsModule(function(module) {
    ...
    lazyProperty(module.exports, 'callSiteToString', function() {
      ...
      return (
        ...
        stack[0].toString ? toString : callsiteTostring
      );
    }),
  ...
  callSiteToString$1 = compat.callSiteToString,
  eventListenerCount$1 = compat.eventListenerCount,
  relative = path$2.relative,
  depd_1 = depd,
  basePath = process.cwd();
function containsNamespace(str, namespace) {
  for (
    var vals = str.split(/[ ,]+/), ns = String(namespace).toLowerCase(), i = 0;
    i < vals.length;
    i++
  ) {
    var val = vals[i];
...
function isignored(namespace) {
  return (
    ...
    containsNamespace(process.env.NO_DEPRECATION || '', namespace)
  );
}
function istraced(namespace) {
  return (
    !!process.traceDeprecation ||
    containsNamespace(process.env.TRACE_DEPRECATION || '', namespace)
  );
}
function log(message, site) {
  var haslisteners = 0 !== eventListenerCount$1(process, 'deprecation');
  if (haslisteners || !this._ignored) {
    ...
    for (
      site
        ? ((depSite = site),
          ((callSite = callSiteLocation(stack[1])).name = depSite.name),
          (file = callSite[0]))
        : (callSite = depSite = callSiteLocation(stack[(i = 2)]));
      i < stack.length;
      i++
    )
      if ((callFile = (caller = callSiteLocation(stack[i]))[0]) === file)
        seen = !0;
    ...
    if (!(void 0 !== key && key in this._warned)) {
      ...
      if (
        ...
        var output = (process.stderr.isTTY ? formatColor : formatPlain).call(
          this,
          msg,
          caller,
          stack.slice(i)
...
function callSiteLocation(callSite) {
  var file = callSite.getFileName() || '<anonymous>',
    ...
    colm = callSite.getColumnNumber();
  callSite.isEval() && (file = callSite.getEvalOrigin() + ', ' + file);
  var site = [file, line, colm];
  return (
    (site.callSite = callSite), (site.name = callSite.getFunctionName()), site
  );
}
function defaultMessage(site) {
  ...
  var context = callSite.getThis(),
    typeName = context && callSite.getTypeName();
  return (
    'Object' === typeName && (typeName = void 0),
    'Function' === typeName && (typeName = context.name || typeName),
    typeName && callSite.getMethodName() ? typeName + '.' + funcName : funcName
  );
}
function formatPlain(msg, caller, stack) {
  var formatted =
    new Date().toUTCString() + ' ' + this._namespace + ' deprecated ' + msg;
  if (this._traced) {
    for (var i = 0; i < stack.length; i++)
      formatted += '\n    at ' + callSiteToString$1(stack[i]);
    return formatted;
...
function formatColor(msg, caller, stack) {
  ...
  if (this._traced) {
    for (var i = 0; i < stack.length; i++)
      formatted += '\n    [36mat ' + callSiteToString$1(stack[i]) + '[39m';
    return formatted;
  }
...
function getStack() {
  ...
  return (
    (Error.prepareStackTrace = prep), (Error.stackTraceLimit = limit), stack
  );
}
...
function wrapproperty(obj, prop, message) {
  ...
  var deprecate = this,
    site = callSiteLocation(getStack()[1]);
  (site.name = prop),
    'value' in descriptor &&
...
function DeprecationError(namespace, message, stack) {
  ...
  return (
    ...
    Object.defineProperty(error, 'stack', {
      ...
      enumerable: !1,
      get: function() {
        return void 0 !== stackString
          ? stackString
          : (stackString = createStackString.call(this, stack));
      },
      set: function(val) {
        stackString = val;
      }
...
function format(value, options) {
  ...
  var mag = Math.abs(value),
    ...
    decimalPlaces =
      options && void 0 !== options.decimalPlaces ? options.decimalPlaces : 2,
...
function parse(val) {
  ...
  return (
    results
      ...
      : ((floatValue = parseInt(val, 10)), (unit = 'b')),
    Math.floor(map[unit] * floatValue)
  );
}
(bytes_1.format = format_1), (bytes_1.parse = parse_1);
...
function format$1(obj) {
  ...
  if (parameters && 'object' == typeof parameters)
    for (
      var param, params = Object.keys(parameters).sort(), i = 0;
      i < params.length;
      i++
    ) {
...
function parse$1(string) {
  ...
  var index = header.indexOf(';'),
    type = -1 !== index ? header.substr(0, index).trim() : header.trim();
...
function getcontenttype(obj) {
  var header;
  if (
    ('function' == typeof obj.getHeader
      ? (header = obj.getHeader('content-type'))
      : 'object' == typeof obj.headers &&
...
var contentType = { format: format_1$1, parse: parse_1$1 },
  setprototypeof =
...
var codes = {
  ...
  codes$1 = Object.freeze({ default: codes }),
  codes$2 = getCjsExportFromNamespace(codes$1),
  statuses = status;
...
var inherits_browser = createCommonjsModule(function(module) {
  ...
  inherits = createCommonjsModule(function(module) {
    try {
      var util$1 = util;
      if ('function' != typeof util$1.inherits) throw '';
...
var httpErrors = createCommonjsModule(function(module) {
    ...
    function nameFunc(func, name) {
      ...
      desc &&
        desc.configurable &&
        ((desc.value = name), Object.defineProperty(func, 'name', desc));
    }
    (module.exports = function createError() {
      ...
      (HttpError && err instanceof HttpError && err.status === status) ||
        ((err.expose = status < 500), (err.status = err.statusCode = status));
      for (var key in props)
        'status' !== key && 'statusCode' !== key && (err[key] = props[key]);
      return err;
    }),
            ...
            case 400:
              CodeError = (function(HttpError, name, code) {
                ...
                function ClientError(message) {
                  var msg = null != message ? message : statuses[code],
                    err = new Error(msg);
                  return (
  ...
  httpErrors_1 = httpErrors.HttpError,
  s = 1e3,
  m = 60 * s,
  h = 60 * m,
  d = 24 * h,
  ...
  ms = function(val, options) {
    options = options || {};
    var type = typeof val;
    if ('string' === type && val.length > 0) return parse$2(val);
...
var debug = createCommonjsModule(function(module, exports) {
      ...
      function debug() {
        if (debug.enabled) {
          ...
          (args[0] = args[0].replace(/%([a-zA-Z%])/g, function(match, format) {
            ...
            (debug.log || exports.log || console.log.bind(console)).apply(
              self,
              args
            );
        }
    ...
    ((exports = module.exports = createDebug.debug = createDebug.default = createDebug).coerce = function(
      val
    ) {
  ...
  browser = createCommonjsModule(function(module, exports) {
    ...
    ((exports = module.exports = debug).log = function() {
      return (
  ...
  node = createCommonjsModule(function(module, exports) {
    ((exports = module.exports = debug).init = function(debug) {
      debug.inspectOpts = {};
      for (
  ...
  src = createCommonjsModule(function(module) {
...
(PrependBOMWrapper.prototype.write = function(str) {
  return (
    this.addBOM && ((str = BOMChar + str), (this.addBOM = !1)),
    this.encoder.write(str)
  );
}),
...
var bomHandling = { PrependBOM, StripBOM },
...
StringDecoder.prototype.end || (StringDecoder.prototype.end = function() {}),
  ...
  (InternalEncoderCesu8.prototype.write = function(str) {
    for (
      var buf = Buffer$2.alloc(3 * str.length), bufIdx = 0, i = 0;
      i < str.length;
      i++
    ) {
  ...
  (InternalDecoderCesu8.prototype.write = function(buf) {
    for (
      ...
      var curByte = buf[i];
      128 != (192 & curByte)
        ? (contBytes > 0 && ((res += this.defaultCharUnicode), (contBytes = 0)),
          curByte < 128
            ? (res += String.fromCharCode(curByte))
            : curByte < 224
            ? ((acc = 31 & curByte), (contBytes = 1), (accBytes = 1))
            : curByte < 240
            ? ((acc = 15 & curByte), (contBytes = 2), (accBytes = 1))
            : (res += this.defaultCharUnicode))
        : contBytes > 0
        ? ((acc = (acc << 6) | (63 & curByte)),
          accBytes++,
          0 === --contBytes &&
            (res +=
              2 === accBytes && acc < 128 && acc > 0
...
(Utf16BECodec.prototype.encoder = Utf16BEEncoder),
  ...
  (Utf16BEEncoder.prototype.write = function(str) {
    for (var buf = Buffer$3.from(str, 'ucs2'), i = 0; i < buf.length; i += 2) {
      var tmp = buf[i];
  ...
  (Utf16BEDecoder.prototype.write = function(buf) {
    ...
    for (
      -1 !== this.overflowByte &&
      ((buf2[0] = buf[0]), (buf2[1] = this.overflowByte), (i = 1), (j = 2));
      i < buf.length - 1;
      i += 2, j += 2
    )
...
function Utf16Encoder(options, codec) {
  void 0 === (options = options || {}).addBOM && (options.addBOM = !0),
...
function detectEncoding(buf, defaultEncoding) {
  ...
  if (buf.length >= 2)
    if (254 == buf[0] && 255 == buf[1]) enc = 'utf-16be';
    else if (255 == buf[0] && 254 == buf[1]) enc = 'utf-16le';
    else {
      for (
        var asciiCharsLE = 0,
          asciiCharsBE = 0,
      ...
      asciiCharsBE > asciiCharsLE
        ? (enc = 'utf-16be')
        : asciiCharsBE < asciiCharsLE && (enc = 'utf-16le');
    }
  return enc;
}
  ...
  (Utf16Decoder.prototype.write = function(buf) {
    if (!this.decoder) {
      ...
      var encoding = detectEncoding(
        (buf = Buffer$3.concat(this.initialBytes)),
...
var utf16 = { utf16be, utf16: utf16_1 },
...
(Utf7Decoder.prototype.write = function(buf) {
  ...
  if (inBase64) {
    var canBeDecoded =
      (b64str = base64Accum + buf.slice(lastI).toString()).length -
      (b64str.length % 8);
  ...
  (Utf7IMAPEncoder.prototype.write = function(str) {
    for (
      var inBase64 = this.inBase64,
        ...
        buf = Buffer$4.alloc(5 * str.length + 10),
        bufIdx = 0,
        i = 0;
      i < str.length;
      i++
      ...
      32 <= uChar && uChar <= 126
        ? (inBase64 &&
          ...
          inBase64 ||
            ((buf[bufIdx++] = uChar),
            uChar === andChar && (buf[bufIdx++] = minusChar)))
        : (inBase64 || ((buf[bufIdx++] = andChar), (inBase64 = !0)),
          inBase64 &&
            ((base64Accum[base64AccumIdx++] = uChar >> 8),
            (base64Accum[base64AccumIdx++] = 255 & uChar),
            base64AccumIdx == base64Accum.length &&
              ((bufIdx += buf.write(
...
var utf7 = { utf7: utf7_1, unicode11utf7, utf7imap },
...
function SBCSCodec(codecOptions, iconv) {
  ...
  if (
    !codecOptions.chars ||
    (128 !== codecOptions.chars.length && 256 !== codecOptions.chars.length)
  )
    throw new Error(
      "Encoding '" +
        codecOptions.type +
  ...
  for (i = 0; i < codecOptions.chars.length; i++)
...
(SBCSCodec.prototype.encoder = SBCSEncoder),
  ...
  (SBCSEncoder.prototype.write = function(str) {
    for (var buf = Buffer$5.alloc(str.length), i = 0; i < str.length; i++)
  ...
  (SBCSDecoder.prototype.write = function(buf) {
    for (
      var decodeBuf = this.decodeBuf,
        newBuf = Buffer$5.alloc(2 * buf.length),
        idx1 = 0,
        idx2 = 0,
        i = 0;
      i < buf.length;
      ...
      (idx1 = 2 * buf[i]),
        (newBuf[(idx2 = 2 * i)] = decodeBuf[idx1]),
...
function DBCSCodec(codecOptions, iconv) {
  ...
  if (
    ...
    for (i = 48; i <= 57; i++) fourthByteNode[i] = GB18030_CODE;
  }
}
...
(DBCSCodec.prototype.encoder = DBCSEncoder),
      ...
      if ('string' == typeof part)
        for (var l = 0; l < part.length; ) {
          ...
          if (55296 <= code && code < 56320) {
            ...
            writeTable[curAddr++] =
              65536 + 1024 * (code - 55296) + (codeTrail - 56320);
          } else if (4080 < code && code <= 4095) {
            for (var len = 4095 - code + 2, seq = [], m = 0; m < len; m++)
  ...
  (DBCSCodec.prototype._setEncodeChar = function(uCode, dbcsCode) {
    var bucket = this._getEncodeBucket(uCode),
      low = 255 & uCode;
    bucket[low] <= SEQ_START
      ? (this.encodeTableSeq[SEQ_START - bucket[low]][DEF_CHAR] = dbcsCode)
      : bucket[low] == UNASSIGNED && (bucket[low] = dbcsCode);
  }),
    ...
    for (
      ...
      if (55296 <= uCode && uCode < 57344)
        if (uCode < 56320) {
          ...
          -1 !== leadSurrogate
            ? ((uCode =
                65536 + 1024 * (leadSurrogate - 55296) + (uCode - 56320)),
              (leadSurrogate = -1))
            : (uCode = UNASSIGNED);
      else
        -1 !== leadSurrogate &&
          ((nextChar = uCode), (uCode = UNASSIGNED), (leadSurrogate = -1));
      ...
      if (void 0 !== seqObj && uCode != UNASSIGNED) {
        ...
        'number' == typeof resCode
          ? (dbcsCode = resCode)
          : null == resCode &&
            void 0 !== (resCode = seqObj[DEF_CHAR]) &&
            ((dbcsCode = resCode), (nextChar = uCode)),
          (seqObj = void 0);
      } else if (uCode >= 0) {
      ...
      dbcsCode === UNASSIGNED && (dbcsCode = this.defaultCharSingleByte),
        dbcsCode < 256
          ? (newBuf[j++] = dbcsCode)
          : dbcsCode < 65536
          ? ((newBuf[j++] = dbcsCode >> 8), (newBuf[j++] = 255 & dbcsCode))
  ...
  (DBCSDecoder.prototype.write = function(buf) {
    var newBuf = Buffer$6.alloc(2 * buf.length),
    ...
    for (var i = 0, j = 0; i < buf.length; i++) {
      var uCode,
        curByte = i >= 0 ? buf[i] : prevBuf[i + prevBufOffset];
      if ((uCode = this.decodeTables[nodeIdx][curByte]) >= 0);
      else if (uCode === UNASSIGNED)
        (i = seqStart), (uCode = this.defaultCharUnicode.charCodeAt(0));
        ...
        for (
          var seq = this.decodeTableSeq[SEQ_START - uCode], k = 0;
          k < seq.length - 1;
          k++
        )
          (uCode = seq[k]),
  ...
  (DBCSDecoder.prototype.end = function() {
    for (var ret = ''; this.prevBuf.length > 0; ) {
      ...
      (this.prevBuf = Buffer$6.alloc(0)),
        (this.nodeIdx = 0),
        buf.length > 0 && (ret += this.write(buf));
    }
...
var dbcsCodec = { _dbcs },
  ...
  shiftjis$1 = Object.freeze({ default: shiftjis }),
  eucjp = [
    ['0', '\0', 127],
    ['8ea1', '｡', 62],
    [
  ...
  eucjp$1 = Object.freeze({ default: eucjp }),
  cp936 = [
    ['0', '\0', 127, '€'],
    [
      '8140',
  ...
  cp936$1 = Object.freeze({ default: cp936 }),
  gbkAdded = [
    ['a140', '', 62],
    ['a180', '', 32],
    ['a240', '', 62],
  ...
  gbkAdded$1 = Object.freeze({ default: gbkAdded }),
  uChars = [
    128,
    165,
    169,
  ...
  gb18030Ranges = { uChars, gbChars },
  gb18030Ranges$1 = Object.freeze({ uChars, gbChars, default: gb18030Ranges }),
  cp949 = [
    ['0', '\0', 127],
  ...
  cp949$1 = Object.freeze({ default: cp949 }),
  cp950 = [
    ['0', '\0', 127],
    [
      'a140',
  ...
  cp950$1 = Object.freeze({ default: cp950 }),
  big5Added = [
    [
      '8740',
  ...
  big5Added$1 = Object.freeze({ default: big5Added }),
  ...
  encodings = createCommonjsModule(function(module, exports) {
    for (
      var modules = [
          internal,
          utf16,
      ...
      for (var enc in module)
        Object.prototype.hasOwnProperty.call(module, enc) &&
...
function IconvLiteEncoderStream(conv, options) {
  (this.conv = conv),
    ((options = options || {}).decodeStrings = !1),
          ...
          if (
            ...
            (SlowBuffer.prototype.toString = function(encoding, start, end) {
              return (
                ...
                Buffer$8.isNativeEncoding(encoding)
                  ? original.SlowBufferToString.call(this, encoding, start, end)
                  : (void 0 === start && (start = 0),
                    void 0 === end && (end = this.length),
                    iconv.decode(this.slice(start, end), encoding))
              );
            }),
            ...
            (SlowBuffer.prototype.write = function(
              ...
              return (
                buf.length < length && (length = buf.length),
            ...
            (Buffer$8.byteLength = SlowBuffer.byteLength = function(
              str,
              encoding
            ) {
              return (
            ...
            (Buffer$8.prototype.toString = function(encoding, start, end) {
              return (
                (encoding = String(encoding || 'utf8').toLowerCase()),
                Buffer$8.isNativeEncoding(encoding)
                  ? original.BufferToString.call(this, encoding, start, end)
                  : (void 0 === start && (start = 0),
                    void 0 === end && (end = this.length),
                    iconv.decode(this.slice(start, end), encoding))
              );
            ...
            (Buffer$8.prototype.write = function(
              string,
              offset,
              length,
              encoding
  ...
  lib = createCommonjsModule(function(module) {
    ...
    (iconv.encodings = null),
      ...
      (iconv.getCodec = function(encoding) {
        iconv.encodings || (iconv.encodings = encodings);
        for (
          var enc = iconv._canonicalizeEncoding(encoding), codecOptions = {};
          ;
    ...
    if (nodeVer) {
      ...
      (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) && streams(iconv),
        extendNode(iconv);
    }
  }),
  unpipe_1 = unpipe;
function hasPipeDataListeners(stream) {
  for (
    var listeners = stream.listeners('data'), i = 0;
    i < listeners.length;
    i++
  )
    if ('ondata' === listeners[i].name) return !0;
  return !1;
}
function unpipe(stream) {
  ...
  if ('function' != typeof stream.unpipe) {
    if (hasPipeDataListeners(stream))
      for (
        var listener, listeners = stream.listeners('close'), i = 0;
        i < listeners.length;
        i++
      )
        ('cleanup' !== (listener = listeners[i]).name &&
          'onclose' !== listener.name) ||
          listener.call(stream);
  } else stream.unpipe();
}
var rawBody = getRawBody,
  ICONV_ENCODING_MESSAGE_REGEXP = /^Encoding not recognized: /;
...
function getRawBody(stream, options, callback) {
  var done = callback,
    opts = options || {};
  if (
    ((!0 !== options && 'string' != typeof options) ||
      (opts = { encoding: options }),
    'function' == typeof options && ((done = options), (opts = {})),
    void 0 !== done && 'function' != typeof done)
  )
    throw new TypeError('argument callback must be a function');
  if (!done && !commonjsGlobal.Promise)
    throw new TypeError('argument callback is required');
  var encoding = !0 !== opts.encoding ? opts.encoding : 'utf-8',
    limit = bytes_1.parse(opts.limit),
    length =
      null == opts.length || isNaN(opts.length)
        ? null
        : parseInt(opts.length, 10);
  return done
    ? readStream(stream, encoding, length, limit, done)
...
function halt(stream) {
  unpipe_1(stream), 'function' == typeof stream.pause && stream.pause();
}
function readStream(stream, encoding, length, limit, callback) {
  var complete = !1,
    sync = !0;
  if (null !== limit && null !== length && length > limit)
    return done(
  ...
  function onEnd(err) {
    if (!complete) {
      ...
      if (null !== length && received !== length)
        done(
...
function first(stuff, done) {
  ...
  for (var cleanups = [], i = 0; i < stuff.length; i++) {
    ...
    for (var ee = arr[0], j = 1; j < arr.length; j++) {
      var event = arr[j],
        fn = listener(event, callback);
      ee.on(event, fn), cleanups.push({ ee, event, fn });
    }
  }
  function callback() {
  ...
  function cleanup() {
    for (var x, i = 0; i < cleanups.length; i++)
      (x = cleanups[i]).ee.removeListener(x.event, x.fn);
  }
  function thunk(fn) {
    done = fn;
  }
...
function onFinished(msg, listener) {
  return !1 !== isFinished(msg)
    ? (defer(listener, null, msg), msg)
    : (attachListener(msg, listener), msg);
}
function isFinished(msg) {
  var socket = msg.socket;
  return 'boolean' == typeof msg.finished
    ? Boolean(msg.finished || (socket && !socket.writable))
    : 'boolean' == typeof msg.complete
    ? Boolean(
        msg.upgrade ||
          !socket ||
          !socket.readable ||
  ...
  (eeMsg = eeSocket = eeFirst([[msg, 'end', 'finish']], onFinish)),
    msg.socket
      ...
      : (msg.on('socket', onSocket),
        void 0 === msg.socket && patchAssignSocket(msg, onSocket));
}
function attachListener(msg, listener) {
  var attached = msg.__onFinished;
  (attached && attached.queue) ||
...
function createListener(msg) {
  function listener(err) {
    if (
      (msg.__onFinished === listener && (msg.__onFinished = null),
      listener.queue)
    ) {
...
function read(req, res, next, parse, debug, options) {
  ...
  var encoding = null !== opts.encoding ? opts.encoding : null,
    verify = opts.verify;
  try {
    (length = (stream = contentstream(req, debug, opts.inflate)).length),
  ...
  debug('read body'),
    rawBody(stream, opts, function(error, body) {
      ...
      if (error)
        return (
          (_error =
            'encoding.unsupported' === error.type
              ? httpErrors(
                  415,
              ...
              : httpErrors(400, error)),
          stream.resume(),
          void onFinished_1(req, function() {
      ...
      try {
        debug('parse body'),
          (str =
            'string' != typeof body && null !== encoding
...
var paramRegExp = /; *([!#$%&'\*\+\-\.0-9A-Z\^_`a-z\|~]+) *= *("(?:[ !\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u0020-\u007e])*"|[!#$%&'\*\+\-\.0-9A-Z\^_`a-z\|~]+) */g,
  textRegExp = /^[\u0020-\u007e\u0080-\u00ff]+$/,
  tokenRegExp = /^[!#$%&'\*\+\-\.0-9A-Z\^_`a-z\|~]+$/,
  qescRegExp = /\\([\u0000-\u007f])/g,
  quoteRegExp = /([\\"])/g,
  subtypeNameRegExp = /^[A-Za-z0-9][A-Za-z0-9!#$&^_.-]{0,126}$/,
  typeNameRegExp = /^[A-Za-z0-9][A-Za-z0-9!#$&^_-]{0,126}$/,
  typeRegExp = /^ *([A-Za-z0-9][A-Za-z0-9!#$&^_-]{0,126})\/([A-Za-z0-9][A-Za-z0-9!#$&^_.+-]{0,126}) *$/,
  format_1$2 = format$2,
  parse_1$2 = parse$3;
function format$2(obj) {
  ...
  if (parameters && 'object' == typeof parameters)
    for (
      ...
      if (((param = params[i]), !tokenRegExp.test(param)))
        throw new TypeError('invalid parameter name');
...
function parse$3(string) {
  if (!string) throw new TypeError('argument string is required');
  if (
    ('object' == typeof string && (string = getcontenttype$1(string)),
  ...
  var key,
    ...
    obj = splitType(-1 !== index ? string.substr(0, index) : string),
    params = {};
  ...
  if (-1 !== index && index !== string.length)
    throw new TypeError('invalid parameter format');
  return (obj.parameters = params), obj;
}
function getcontenttype$1(obj) {
  return 'function' == typeof obj.getHeader
    ? obj.getHeader('content-type')
    : 'object' == typeof obj.headers
    ? obj.headers && obj.headers['content-type']
    : void 0;
}
...
var mediaTyper = { format: format_1$2, parse: parse_1$2 },
  db = {
    ...
    'application/atsc-dwd+xml': { source: 'iana', compressible: !0 },
    'application/atsc-held+xml': { source: 'iana', compressible: !0 },
    'application/atsc-rsat+xml': { source: 'iana', compressible: !0 },
    ...
    'application/mmt-aei+xml': { source: 'iana', compressible: !0 },
  ...
  db$1 = Object.freeze({ default: db }),
  require$$0$1 = getCjsExportFromNamespace(db$1),
  mimeDb = require$$0$1,
  mimeTypes = createCommonjsModule(function(module, exports) {
    ...
    function charset(type) {
      ...
      var match = EXTRACT_TYPE_REGEXP.exec(type),
        mime = match && mimeDb[match[1].toLowerCase()];
      return mime && mime.charset
        ? mime.charset
        : !(!match || !TEXT_TYPE_REGEXP.test(match[1])) && 'UTF-8';
    }
    (exports.charset = charset),
      ...
      (function(extensions, types) {
        var preference = ['nginx', 'apache', void 0, 'iana'];
        Object.keys(mimeDb).forEach(function(type) {
          ...
          if (exts && exts.length) {
            ...
            for (var i = 0; i < exts.length; i++) {
              ...
              if (types[extension]) {
                ...
                if (
                  'application/octet-stream' !== types[extension] &&
                  (from > to ||
                    (from === to &&
                      'application/' === types[extension].substr(0, 12)))
                )
                  continue;
              }
      ...
      })(exports.extensions, exports.types);
  }),
  mimeTypes_1 = mimeTypes.charset,
  mimeTypes_2 = mimeTypes.charsets,
  mimeTypes_3 = mimeTypes.contentType,
  mimeTypes_4 = mimeTypes.extension,
  mimeTypes_5 = mimeTypes.extensions,
  mimeTypes_6 = mimeTypes.lookup,
  mimeTypes_7 = mimeTypes.types,
  typeIs = typeofrequest,
  is = typeis,
  hasBody = hasbody,
...
function typeis(value, types_) {
  ...
  if (types && !Array.isArray(types))
    for (types = new Array(arguments.length - 1), i = 0; i < types.length; i++)
      types[i] = arguments[i + 1];
  if (!types || !types.length) return val;
  for (i = 0; i < types.length; i++)
    if (mimeMatch(normalize((type = types[i])), val))
      return '+' === type[0] || -1 !== type.indexOf('*') ? val : type;
  return !1;
}
function hasbody(req) {
  return (
    void 0 !== req.headers['transfer-encoding'] ||
...
function mimeMatch(expected, actual) {
  ...
  return (
    2 === actualParts.length &&
    2 === expectedParts.length &&
    (('*' === expectedParts[0] || expectedParts[0] === actualParts[0]) &&
      ('*+' === expectedParts[1].substr(0, 2)
        ? expectedParts[1].length <= actualParts[1].length + 1 &&
          expectedParts[1].substr(1) ===
            actualParts[1].substr(1 - expectedParts[1].length)
        : '*' === expectedParts[1] || expectedParts[1] === actualParts[1]))
  );
}
function normalizeType(value) {
  var type = mediaTyper.parse(value);
  return (type.parameters = void 0), mediaTyper.format(type);
}
...
function json(options) {
  var opts = options || {},
    limit =
      'number' != typeof opts.limit
        ? bytes_1.parse(opts.limit || '100kb')
        : opts.limit,
    inflate = !1 !== opts.inflate,
    reviver = opts.reviver,
    strict = !1 !== opts.strict,
    type = opts.type || 'application/json',
    verify = opts.verify || !1;
  if (!1 !== verify && 'function' != typeof verify)
  ...
  function parse(body) {
    ...
    if (strict) {
      ...
      if ('{' !== first && '[' !== first)
        throw (debug$1('strict violation'),
        createStrictSyntaxError(body, first));
    }
    try {
      return debug$1('parse json'), JSON.parse(body, reviver);
    } catch (e) {
      throw normalizeJsonSyntaxError(e, { message: e.message, stack: e.stack });
    }
  }
  return function(req, res, next) {
    if (req._body) return debug$1('body already parsed'), void next();
    if (((req.body = req.body || {}), !typeIs.hasBody(req)))
      return debug$1('skip empty body'), void next();
    if (
      (debug$1('content-type %j', req.headers['content-type']),
      !shouldParse(req))
    )
      return debug$1('skip parsing'), void next();
    var charset = getCharset(req) || 'utf-8';
    if ('utf-' !== charset.substr(0, 4))
      return (
        ...
        void next(
          httpErrors(
            ...
            { charset, type: 'charset.unsupported' }
          )
        )
      );
...
function normalizeJsonSyntaxError(error, obj) {
  for (
    var keys = Object.getOwnPropertyNames(error), i = 0;
    i < keys.length;
    i++
  ) {
    var key = keys[i];
...
function raw(options) {
  ...
  if (!1 !== verify && 'function' != typeof verify)
    throw new TypeError('option verify must be function');
  var shouldParse = 'function' != typeof type ? typeChecker$1(type) : type;
  function parse(buf) {
    return buf;
  }
  return function(req, res, next) {
    return req._body
      ? (debug$2('body already parsed'), void next())
      : ((req.body = req.body || {}),
        typeIs.hasBody(req)
          ? (debug$2('content-type %j', req.headers['content-type']),
            shouldParse(req)
              ? void read_1(req, res, next, parse, debug$2, {
                  encoding: null,
                  inflate,
                  limit,
                  verify
                })
              : (debug$2('skip parsing'), void next()))
          : (debug$2('skip empty body'), void next()));
  };
}
...
function text(options) {
  var opts = options || {},
    defaultCharset = opts.defaultCharset || 'utf-8',
    inflate = !1 !== opts.inflate,
    limit =
      'number' != typeof opts.limit
        ? bytes_1.parse(opts.limit || '100kb')
  ...
  if (!1 !== verify && 'function' != typeof verify)
    throw new TypeError('option verify must be function');
  var shouldParse = 'function' != typeof type ? typeChecker$2(type) : type;
  function parse(buf) {
    return buf;
  }
  return function(req, res, next) {
    if (req._body) return debug$3('body already parsed'), void next();
    if (((req.body = req.body || {}), !typeIs.hasBody(req)))
      return debug$3('skip empty body'), void next();
    if (
      (debug$3('content-type %j', req.headers['content-type']),
      !shouldParse(req))
    )
      return debug$3('skip parsing'), void next();
...
var has = Object.prototype.hasOwnProperty,
    ...
    for (i = 0; i < parts.length; ++i)
      if (i !== skipIndex) {
        var key,
          ...
          pos =
            -1 === bracketEqualsPos ? part.indexOf('=') : bracketEqualsPos + 1;
        -1 === pos
  ...
  normalizeParseOptions = function(opts) {
    ...
    return {
      ...
      decoder:
        'function' == typeof opts.decoder ? opts.decoder : defaults$1.decoder,
      delimiter:
  ...
  lib$1 = { formats, parse: parse$4, stringify: stringify_1 },
  debug$4 = src('body-parser:urlencoded'),
  deprecate = depd_1('body-parser'),
  urlencoded_1 = urlencoded,
  parsers = Object.create(null);
function urlencoded(options) {
  var opts = options || {};
  void 0 === opts.extended &&
    deprecate('undefined extended: provide extended option');
  var extended = !1 !== opts.extended,
    inflate = !1 !== opts.inflate,
    limit =
      'number' != typeof opts.limit
        ? bytes_1.parse(opts.limit || '100kb')
        : opts.limit,
    type = opts.type || 'application/x-www-form-urlencoded',
    verify = opts.verify || !1;
  if (!1 !== verify && 'function' != typeof verify)
    throw new TypeError('option verify must be function');
  var queryparse = extended ? extendedparser(opts) : simpleparser(opts),
    shouldParse = 'function' != typeof type ? typeChecker$3(type) : type;
  function parse(body) {
    return body.length ? queryparse(body) : {};
  }
  return function(req, res, next) {
    if (req._body) return debug$4('body already parsed'), void next();
    if (((req.body = req.body || {}), !typeIs.hasBody(req)))
      return debug$4('skip empty body'), void next();
    if (
      (debug$4('content-type %j', req.headers['content-type']),
      !shouldParse(req))
    )
      return debug$4('skip parsing'), void next();
...
function extendedparser(options) {
  var parameterLimit =
      void 0 !== options.parameterLimit ? options.parameterLimit : 1e3,
    parse = parser('qs');
  if (isNaN(parameterLimit) || parameterLimit < 1)
    throw new TypeError('option parameterLimit must be a positive number');
  return (
    isFinite(parameterLimit) && (parameterLimit |= 0),
    function(body) {
      var paramCount = parameterCount(body, parameterLimit);
      if (void 0 === paramCount)
        throw (debug$4('too many parameters'),
        httpErrors(413, 'too many parameters', {
...
function parameterCount(body, limit) {
  for (var count = 0, index = 0; -1 !== (index = body.indexOf('&', index)); )
    if ((index++, ++count === limit)) return;
  return count;
}
...
function simpleparser(options) {
  var parameterLimit =
      void 0 !== options.parameterLimit ? options.parameterLimit : 1e3,
    parse = parser('querystring');
  if (isNaN(parameterLimit) || parameterLimit < 1)
    throw new TypeError('option parameterLimit must be a positive number');
  return (
    isFinite(parameterLimit) && (parameterLimit |= 0),
    function(body) {
      if (void 0 === parameterCount(body, parameterLimit))
        throw (debug$4('too many parameters'),
        httpErrors(413, 'too many parameters', {
          type: 'parameters.too.many'
        }));
      return (
        ...
        parse(body, void 0, void 0, { maxKeys: parameterLimit })
      );
    }
  );
}
    ...
    (exports = module.exports = deprecate.function(function(options) {
      ...
      if (options)
        for (var prop in options)
          'type' !== prop && (opts[prop] = options[prop]);
      var _urlencoded = exports.urlencoded(opts),
        _json = exports.json(opts);
      return function(req, res, next) {
...
function parseurl(req) {
  ...
  if (void 0 !== url) {
    ...
    return fresh(url, parsed)
      ? parsed
      : (((parsed = fastparse(url))._raw = url), (req._parsedUrl = parsed));
  }
}
function originalurl(req) {
  ...
  return fresh(url, parsed)
    ? parsed
    : (((parsed = fastparse(url))._raw = url),
      (req._parsedOriginalUrl = parsed));
}
function fastparse(str) {
  if ('string' != typeof str || 47 !== str.charCodeAt(0)) return parse$5(str);
  for (
    var pathname = str, query = null, search = null, i = 1;
    i < str.length;
    i++
  )
  ...
  return (
    ...
    null !== search && ((url.query = query), (url.search = search)),
    url
  );
}
function fresh(url, parsedUrl) {
  return (
    'object' == typeof parsedUrl &&
    null !== parsedUrl &&
    (void 0 === Url || parsedUrl instanceof Url) &&
    parsedUrl._raw === url
  );
}
...
var debug$5 = src('finalhandler'),
  ...
  isFinished$1 = onFinished_1.isFinished;
function createHtmlDocument(message) {
  return (
    '<!DOCTYPE html>\n<html lang="en">\n<head>\n<meta charset="utf-8">\n<title>Error</title>\n</head>\n<body>\n<pre>' +
    escapeHtml_1(message)
...
function finalhandler(req, res, options) {
  ...
  return function(err) {
    ...
    if (err || !headersSent(res)) {
      if (
        (err
          ? (void 0 === (status = getErrorStatusCode(err))
        ...
        err && onerror && defer$1(onerror, err, req, res),
        headersSent(res))
      )
        return (
    ...
    } else debug$5('cannot 404 after headers sent');
  };
}
function getErrorHeaders(err) {
  if (err.headers && 'object' == typeof err.headers) {
    for (
      var headers = Object.create(null), keys = Object.keys(err.headers), i = 0;
      i < keys.length;
      i++
    ) {
      var key = keys[i];
...
function getErrorStatusCode(err) {
  return 'number' == typeof err.status && err.status >= 400 && err.status < 600
    ? err.status
    : 'number' == typeof err.statusCode &&
      err.statusCode >= 400 &&
      err.statusCode < 600
    ? err.statusCode
    : void 0;
...
function getResponseStatusCode(res) {
  ...
  return (
    ('number' != typeof status || status < 400 || status > 599) &&
      (status = 500),
    status
  );
}
function headersSent(res) {
  return 'boolean' != typeof res.headersSent
    ? Boolean(res._header)
    : res.headersSent;
}
function send(req, res, status, headers, message) {
  function write() {
    ...
    (res.statusCode = status),
      ...
      'HEAD' !== req.method ? res.end(body, 'utf8') : res.end();
  }
  isFinished$1(req)
    ? write()
    : (unpipe_1(req), onFinished_1(req, write), req.resume());
}
...
function arrayFlatten(array, depth) {
  return null == depth
    ? flattenForever(array, [])
    : flattenWithDepth(array, [], depth);
}
var pathToRegexp = pathtoRegexp,
  MATCHING_GROUP_REGEXP = /\((?!\?)/g;
function pathtoRegexp(path, keys, options) {
  ...
  var m,
    ...
    extraOffset = 0,
    keysOffset = keys.length,
    i = 0,
    name = 0;
  if (path instanceof RegExp) {
    for (; (m = MATCHING_GROUP_REGEXP.exec(path.source)); )
      keys.push({ name: name++, optional: !1, offset: m.index });
    return path;
  }
  ...
  for (
    path = (
      ...
      .replace(/\*/g, function(star, index) {
        for (
          var len = keys.length;
          len-- > keysOffset && keys[len].offset > index;
    ...
    for (var escapeCount = 0, index = m.index; '\\' === path.charAt(--index); )
      escapeCount++;
    escapeCount % 2 != 1 &&
  ...
  (Layer.prototype.match = function(path) {
    ...
    if (null != path) {
      ...
      if (this.regexp.fast_star)
        return (
          (this.params = { 0: decode_param(path) }), (this.path = path), !0
        );
    ...
    for (
      var keys = this.keys, params = this.params, i = 1;
      i < match.length;
      i++
    ) {
      var prop = keys[i - 1].name,
        val = decode_param(match[i]);
      (void 0 === val && hasOwnProperty$1.call(params, prop)) ||
        (params[prop] = val);
    }
    return !0;
  });
...
function getCurrentNodeMethods() {
  return (
    http.METHODS &&
    http.METHODS.map(function(method) {
...
(Route.prototype._handles_method = function(method) {
  ...
  return (
    'head' !== name || this.methods.head || (name = 'get'),
    Boolean(this.methods[name])
  );
}),
  ...
  (Route.prototype.all = function() {
    for (
      var handles = arrayFlatten_1(slice.call(arguments)), i = 0;
      i < handles.length;
      i++
    ) {
...
var utilsMerge = createCommonjsModule(function(module, exports) {
  ...
  router = createCommonjsModule(function(module) {
    var debug = src('express:router'),
      deprecate = depd_1('express'),
    ...
    function gettype(obj) {
      ...
      return 'object' !== type
        ? type
        : toString.call(obj).replace(objectRegExp, '$1');
    }
    ...
    (proto.param = function(name, fn) {
      ...
      (proto.handle = function(req, res, out) {
          ...
          protohost =
            (function(url) {
              ...
              var searchIndex = url.indexOf('?'),
                ...
                fqdnIndex = url.substr(0, pathLength).indexOf('://');
              return -1 !== fqdnIndex
        ...
        function next(err) {
          ...
          if (
            (slashAdded && ((req.url = req.url.substr(1)), (slashAdded = !1)),
            0 !== removed.length &&
              ((req.baseUrl = parentUrl),
              (req.url =
                protohost + removed + req.url.substr(protohost.length)),
              (removed = '')),
            'router' !== layerError)
          )
            if (idx >= stack.length) setImmediate(done, layerError);
              ...
              self.process_params(layer, paramcalled, req, res, function(err) {
                return err
                  ...
                  : route
                  ? layer.handle_request(req, res, next)
                  : void (function(layer, layerError, layerPath, path) {
                      if (0 !== layerPath.length) {
                        var c = path[layerPath.length];
                        if (c && '/' !== c && '.' !== c)
                          return next(layerError);
                        debug(
                          'trim prefix (%s) from url %s',
                          layerPath,
                          req.url
                        ),
                          (removed = layerPath),
      ...
      (proto.use = function(fn) {
        var offset = 0,
          path = '/';
        if ('function' != typeof fn) {
          for (var arg = fn; Array.isArray(arg) && 0 !== arg.length; )
            arg = arg[0];
        ...
        for (var i = 0; i < callbacks.length; i++) {
          ...
          var layer$1 = new layer(
            path,
            { sensitive: this.caseSensitive, strict: !1, end: !1 },
            fn
          );
          (layer$1.route = void 0), this.stack.push(layer$1);
        }
        return this;
      }),
      (proto.route = function(path) {
        ...
        return (layer$1.route = route$1), this.stack.push(layer$1), route$1;
      }),
  ...
  query = function(options) {
    var opts = utilsMerge({}, options),
      queryparse = lib$1.parse;
    return (
      'function' == typeof options && ((queryparse = options), (opts = void 0)),
      void 0 !== opts &&
        void 0 === opts.allowPrototypes &&
        (opts.allowPrototypes = !0),
...
var safeBuffer = createCommonjsModule(function(module, exports) {
  ...
  safeBuffer_1 = safeBuffer.Buffer,
  contentDisposition_1 = contentDisposition,
  parse_1$3 = parse$6,
  basename$1 = path$2.basename,
  Buffer$9 = safeBuffer.Buffer,
  ENCODE_URL_ATTR_CHAR_REGEXP = /[\x00-\x20"'()*,\/:;<=>?@[\\\]{}\x7f]/g,
  HEX_ESCAPE_REGEXP = /%[0-9A-Fa-f]{2}/,
  HEX_ESCAPE_REPLACE_REGEXP = /%([0-9A-Fa-f]{2})/g,
  NON_LATIN1_REGEXP = /[^\x20-\x7e\xa0-\xff]/g,
  QESC_REGEXP$1 = /\\([\u0000-\u007f])/g,
  QUOTE_REGEXP$1 = /([\\"])/g,
  PARAM_REGEXP$1 = /;[\x09\x20]*([!#$%&'*+.0-9A-Z^_`a-z|~-]+)[\x09\x20]*=[\x09\x20]*("(?:[\x20!\x23-\x5b\x5d-\x7e\x80-\xff]|\\[\x20-\x7e])*"|[!#$%&'*+.0-9A-Z^_`a-z|~-]+)[\x09\x20]*/g,
  TEXT_REGEXP$1 = /^[\x20-\x7e\x80-\xff]+$/,
  TOKEN_REGEXP$1 = /^[!#$%&'*+.0-9A-Z^_`a-z|~-]+$/,
  EXT_VALUE_REGEXP = /^([A-Za-z0-9!#$%&+\-^_`{}~]+)'(?:[A-Za-z]{2,3}(?:-[A-Za-z]{3}){0,3}|[A-Za-z]{4,8}|)'((?:%[0-9A-Fa-f]{2}|[A-Za-z0-9!#$&+.^_`|~-])+)$/,
...
function contentDisposition(filename, options) {
  ...
  return format$3(
    new ContentDisposition(
      ...
      createparams(filename, opts.fallback)
    )
  );
}
function createparams(filename, fallback) {
  if (void 0 !== filename) {
    ...
    if (
      ...
      'string' != typeof fallback && 'boolean' != typeof fallback)
    )
      throw new TypeError('fallback must be a string or boolean');
    if ('string' == typeof fallback && NON_LATIN1_REGEXP.test(fallback))
      throw new TypeError('fallback must be ISO-8859-1 string');
    var name = basename$1(filename),
      isQuotedString = TEXT_REGEXP$1.test(name),
      fallbackName =
        'string' != typeof fallback
          ? fallback && getlatin1(name)
          : basename$1(fallback),
      hasFallback = 'string' == typeof fallbackName && fallbackName !== name;
    return (
      (hasFallback || !isQuotedString || HEX_ESCAPE_REGEXP.test(name)) &&
        (params['filename*'] = name),
      (isQuotedString || hasFallback) &&
...
function format$3(obj) {
  var parameters = obj.parameters,
    type = obj.type;
  if (!type || 'string' != typeof type || !TOKEN_REGEXP$1.test(type))
...
function decodefield(str) {
  ...
  var value,
    ...
    binary = match[2].replace(HEX_ESCAPE_REPLACE_REGEXP, pdecode);
  switch (charset) {
    case 'iso-8859-1':
...
function parse$6(string) {
  ...
  var key,
    ...
    params = {};
  for (
    index = PARAM_REGEXP$1.lastIndex =
      ';' === match[0].substr(-1) ? index - 1 : index;
    (match = PARAM_REGEXP$1.exec(string));
...
function qstring$2(val) {
  return '"' + String(val).replace(QUOTE_REGEXP$1, '\\$1') + '"';
}
function ustring(val) {
  var str = String(val);
  return (
    "UTF-8''" +
    encodeURIComponent(str).replace(ENCODE_URL_ATTR_CHAR_REGEXP, pencode)
  );
}
...
function destroy(stream$1) {
  return stream$1 instanceof ReadStream
    ? destroyReadStream(stream$1)
    : stream$1 instanceof stream
    ? ('function' == typeof stream$1.destroy && stream$1.destroy(), stream$1)
    : stream$1;
}
function destroyReadStream(stream) {
  return (
    stream.destroy(),
    'function' == typeof stream.close && stream.on('open', onOpenClose),
    stream
  );
}
...
function etag(entity, options) {
  ...
  var isStats = isstats(entity),
    weak = options && 'boolean' == typeof options.weak ? options.weak : isStats;
  if (!isStats && 'string' != typeof entity && !Buffer.isBuffer(entity))
...
function isstats(obj) {
  return (
    ('function' == typeof Stats && obj instanceof Stats) ||
    (obj &&
      'object' == typeof obj &&
      'ctime' in obj &&
      '[object Date]' === toString$1.call(obj.ctime) &&
      'mtime' in obj &&
      '[object Date]' === toString$1.call(obj.mtime) &&
      'ino' in obj &&
      'number' == typeof obj.ino &&
      'size' in obj &&
      'number' == typeof obj.size)
  );
}
...
function fresh$1(reqHeaders, resHeaders) {
  var modifiedSince = reqHeaders['if-modified-since'],
    noneMatch = reqHeaders['if-none-match'];
  ...
  if (noneMatch && '*' !== noneMatch) {
    ...
    if (!etag) return !1;
    for (
      var etagStale = !0, matches = parseTokenList(noneMatch), i = 0;
      i < matches.length;
      i++
    ) {
      var match = matches[i];
...
function parseTokenList(str) {
  for (var end = 0, list = [], start = 0, i = 0, len = str.length; i < len; i++)
    switch (str.charCodeAt(i)) {
      case 32:
...
var types = {
  ...
  types$1 = Object.freeze({ default: types }),
  require$$0$2 = getCjsExportFromNamespace(types$1);
function Mime() {
  (this.types = Object.create(null)), (this.extensions = Object.create(null));
}
(Mime.prototype.define = function(map) {
  for (var type in map) {
    for (var exts = map[type], i = 0; i < exts.length; i++)
...
var mime_1 = mime,
  ...
  ms$1 = function(val, options) {
    options = options || {};
    var type = typeof val;
    if ('string' === type && val.length > 0) return parse$7(val);
    if ('number' === type && !1 === isNaN(val))
...
function fmtLong$1(ms) {
  var msAbs = Math.abs(ms);
  return msAbs >= d$1
    ? plural$1(ms, msAbs, d$1, 'day')
    : msAbs >= h$1
    ? plural$1(ms, msAbs, h$1, 'hour')
    : msAbs >= m$1
    ? plural$1(ms, msAbs, m$1, 'minute')
    : msAbs >= s$1
    ? plural$1(ms, msAbs, s$1, 'second')
    : ms + ' ms';
}
...
function rangeParser(size, str, options) {
  ...
  return ranges.length < 1
    ? -1
    : options && options.combine
    ? combineRanges(ranges)
    : ranges;
}
function combineRanges(ranges) {
  for (
    var ordered = ranges.map(mapWithIndex).sort(sortByRangeStart), j = 0, i = 1;
    i < ordered.length;
    i++
  ) {
    var range = ordered[i],
...
var debug$9 = src('send'),
  deprecate$1 = depd_1('send'),
  path$1 = path$2,
  extname$1 = path$1.extname,
  join$1 = path$1.join,
  normalize$1 = path$1.normalize,
  resolve$1 = path$1.resolve,
  sep = path$1.sep,
...
function SendStream(req, path, options) {
  ...
  if (
    ...
    (this.req = req),
    (this._acceptRanges =
      void 0 === opts.acceptRanges || Boolean(opts.acceptRanges)),
    (this._cacheControl =
      void 0 === opts.cacheControl || Boolean(opts.cacheControl)),
    (this._etag = void 0 === opts.etag || Boolean(opts.etag)),
  ...
  (this._hidden = Boolean(opts.hidden)),
    ...
    void 0 === opts.dotfiles && (this._dotfiles = void 0),
    (this._extensions =
      void 0 !== opts.extensions
        ? normalizeList(opts.extensions, 'extensions option')
        : []),
    (this._immutable = void 0 !== opts.immutable && Boolean(opts.immutable)),
    (this._index =
      void 0 !== opts.index
        ? normalizeList(opts.index, 'index option')
        : ['index.html']),
    (this._lastModified =
      void 0 === opts.lastModified || Boolean(opts.lastModified)),
    ...
    !this._root && opts.from && this.from(opts.from);
}
function clearHeaders(res) {
  for (var headers = getHeaderNames(res), i = 0; i < headers.length; i++)
...
function getHeaderNames(res) {
  return 'function' != typeof res.getHeaderNames
    ? Object.keys(res._headers || {})
    : res.getHeaderNames();
}
function hasListeners(emitter, type) {
  return (
    ('function' != typeof emitter.listenerCount
...
function normalizeList(val, name) {
  for (var list = [].concat(val || []), i = 0; i < list.length; i++)
...
util.inherits(SendStream, stream),
  (SendStream.prototype.etag = deprecate$1.function(function(val) {
    return (this._etag = Boolean(val)), debug$9('etag %s', this._etag), this;
  }, 'send.etag: pass etag as option')),
  (SendStream.prototype.hidden = deprecate$1.function(function(val) {
    return (
  ...
  (SendStream.prototype.index = deprecate$1.function(function(paths) {
    var index = paths ? normalizeList(paths, 'paths argument') : [];
    return debug$9('index %o', paths), (this._index = index), this;
  ...
  (SendStream.prototype.from = deprecate$1.function(
    SendStream.prototype.root,
    'send.from: pass root as option'
  )),
  (SendStream.prototype.root = deprecate$1.function(
    SendStream.prototype.root,
    'send.root: pass root as option'
  )),
  (SendStream.prototype.maxage = deprecate$1.function(function(maxAge) {
    return (
      (this._maxage =
        'string' == typeof maxAge ? ms$1(maxAge) : Number(maxAge)),
      (this._maxage = isNaN(this._maxage)
        ? 0
        : Math.min(Math.max(0, this._maxage), MAX_MAXAGE)),
  ...
  (SendStream.prototype.error = function(status, err) {
    if (hasListeners(this, 'error'))
      return this.emit('error', httpErrors(status, err, { expose: !1 }));
    var res = this.res,
      msg = statuses[status] || String(status),
      doc = createHtmlDocument$1('Error', escapeHtml_1(msg));
    clearHeaders(res),
      err && err.headers && setHeaders$1(res, err.headers),
      (res.statusCode = status),
      res.setHeader('Content-Type', 'text/html; charset=UTF-8'),
  ...
  (SendStream.prototype.isPreconditionFailure = function() {
    ...
    if (match) {
      ...
      return (
        !etag ||
        ('*' !== match &&
          parseTokenList$1(match).every(function(match) {
            return (
  ...
  (SendStream.prototype.removeContentHeaderFields = function() {
    for (
      var res = this.res, headers = getHeaderNames(res), i = 0;
      i < headers.length;
      i++
    ) {
      var header = headers[i];
      'content-' === header.substr(0, 8) &&
  ...
  (SendStream.prototype.headersAlreadySent = function() {
    ...
    debug$9('headers already sent'), this.error(500, err);
  }),
  ...
  (SendStream.prototype.isRangeFresh = function() {
    ...
    return (
      parseHttpDate$1(this.res.getHeader('Last-Modified')) <=
      parseHttpDate$1(ifRange)
    );
  }),
  (SendStream.prototype.redirect = function(path) {
    var res = this.res;
    if (hasListeners(this, 'directory')) this.emit('directory', res, path);
    else if (this.hasTrailingSlash()) this.error(403);
    else {
      var loc = encodeurl(collapseLeadingSlashes(this.path + '/')),
        doc = createHtmlDocument$1(
          'Redirecting',
  ...
  (SendStream.prototype.pipe = function(res) {
    ...
    this.res = res;
    var parts,
      path = decode$1(this.path);
    if (-1 === path) return this.error(400), res;
    if (~path.indexOf('\0')) return this.error(400), res;
    if (null !== root) {
      if (
        (path && (path = normalize$1('.' + sep + path)),
        UP_PATH_REGEXP.test(path))
      )
        return debug$9('malicious path "%s"', path), this.error(403), res;
      (parts = path.split(sep)), (path = normalize$1(join$1(root, path)));
    } else {
      if (UP_PATH_REGEXP.test(path))
        return debug$9('malicious path "%s"', path), this.error(403), res;
      (parts = normalize$1(path).split(sep)), (path = resolve$1(path));
    }
  ...
  (SendStream.prototype.send = function(path, stat) {
    ...
    if (headersSent$1(res)) this.headersAlreadySent();
    else {
      if (
        (debug$9('pipe "%s"', path),
      ...
      if (this._acceptRanges && BYTES_RANGE_REGEXP.test(ranges)) {
        if (
          ((ranges = rangeParser_1(len, ranges, { combine: !0 })),
          this.isRangeFresh() || (debug$9('range stale'), (ranges = -2)),
          -1 === ranges)
        )
          return (
    ...
    debug$9('stat "%s"', path),
      fs.stat(path, function(err, stat) {
        return err &&
          ...
          ? (function next(err) {
              ...
              fs.stat(p, function(err, stat) {
                return err
                  ...
                  : stat.isDirectory()
                  ? next()
                  : (self.emit('file', p, stat), void self.send(p, stat));
              });
            })(err)
          : err
          ...
          : stat.isDirectory()
          ? self.redirect(path)
          : (self.emit('file', path, stat), void self.send(path, stat));
      });
  }),
  ...
  (SendStream.prototype.stream = function(path, options) {
    ...
    this.emit('stream', stream),
      stream.pipe(res),
      onFinished_1(res, function() {
        (finished = !0), destroy_1(stream);
      }),
      stream.on('error', function(err) {
        finished || ((finished = !0), destroy_1(stream), self.onStatError(err));
      }),
  ...
  (SendStream.prototype.setHeader = function(path, stat) {
    ...
    if (
      ...
      this._acceptRanges &&
        ...
        (debug$9('accept ranges'), res.setHeader('Accept-Ranges', 'bytes')),
      this._cacheControl && !res.getHeader('Cache-Control'))
    ) {
      var cacheControl = 'public, max-age=' + Math.floor(this._maxage / 1e3);
      this._immutable && (cacheControl += ', immutable'),
    ...
    if (this._etag && !res.getHeader('ETag')) {
      var val = etag_1(stat);
      debug$9('etag %s', val), res.setHeader('ETag', val);
    }
  }),
    ...
    (function() {
      ...
      (ipaddr = {}),
        ...
        (ipaddr.subnetMatch = function(address, rangeList, defaultName) {
          ...
          for (rangeName in (null == defaultName && (defaultName = 'unicast'),
          rangeList))
            for (
        ...
        (ipaddr.IPv4 = (function() {
          ...
          return (
            ...
            (IPv4.prototype.match = function(other, cidrRange) {
              ...
              if (
                (void 0 === cidrRange &&
                  ((other = (ref = other)[0]), (cidrRange = ref[1])),
                'ipv4' !== other.kind())
              )
                throw new Error(
            ...
            (IPv4.prototype.prefixLengthFromSubnetMask = function() {
              ...
              for (
                ...
                if (((zeros = zerotable[octet]), stop && 0 !== zeros))
                  return null;
        ...
        (ipaddr.IPv4.parser = function(string) {
          ...
          if (
            ...
            return (function() {
              ...
              for (
                results = [], k = 0, len = (ref = match.slice(1, 6)).length;
                k < len;
                k++
              )
        ...
        (ipaddr.IPv6 = (function() {
          ...
          return (
            ...
            (IPv6.prototype.toByteArray = function() {
              ...
              for (
                bytes = [], k = 0, len = (ref = this.parts).length;
                k < len;
                k++
              )
            ...
            (IPv6.prototype.toNormalizedString = function() {
              ...
              return (
                (addr = function() {
                  var k, len, ref, results;
                  for (
                    results = [], k = 0, len = (ref = this.parts).length;
                    k < len;
                    k++
                  )
            ...
            (IPv6.prototype.prefixLengthFromSubnetMask = function() {
              ...
              for (
                ...
                if (((zeros = zerotable[part]), stop && 0 !== zeros))
                  return null;
        ...
        (expandIPv6 = function(string, parts) {
          ...
          if (
            ...
            return null;
          for (
            replacementCount = parts - colonCount, replacement = ':';
            replacementCount--;
        ...
        (ipaddr.IPv6.isValid = function(string) {
          var addr;
          if ('string' == typeof string && -1 === string.indexOf(':'))
            return !1;
          try {
            return (
              new this((addr = this.parser(string)).parts, addr.zoneId), !0
            );
          } catch (error1) {
            return !1;
          }
        ...
        (ipaddr.IPv4.broadcastAddressFromCIDR = function(string) {
          ...
          try {
            for (
              ipInterfaceOctets = (cidr = this.parseCIDR(
                string
              ))[0].toByteArray(),
        ...
        (ipaddr.process = function(string) {
          var addr;
          return 'ipv6' === (addr = this.parse(string)).kind() &&
...
function alladdrs(req, trust) {
  ...
  for (var i = 0; i < addrs.length - 1; i++)
    trust(addrs[i], i) || (addrs.length = i + 1);
  return addrs;
}
...
(proxyAddr.all = all), (proxyAddr.compile = compile_1);
var utils$1 = createCommonjsModule(function(module, exports) {
    ...
    function parseExtendedQueryString(str) {
      return lib$1.parse(str, { allowPrototypes: !0 });
    }
    function newObject() {
      return {};
    }
    (exports.etag = createETagGenerator({ weak: !1 })),
      ...
      (exports.compileTrust = function(val) {
        return 'function' == typeof val
          ...
          : ('string' == typeof val && (val = val.split(/ *, */)),
      ...
      (exports.setCharset = function(type, charset) {
        ...
        return (
          (parsed.parameters.charset = charset), contentType.format(parsed)
        );
      });
  }),
  utils_1 = utils$1.etag,
  utils_2 = utils$1.wetag,
  utils_3 = utils$1.isAbsolute,
  utils_4 = utils$1.flatten,
  utils_5 = utils$1.normalizeType,
  utils_6 = utils$1.normalizeTypes,
  utils_7 = utils$1.contentDisposition,
  utils_8 = utils$1.compileETag,
  utils_9 = utils$1.compileQueryParser,
  utils_10 = utils$1.compileTrust,
  utils_11 = utils$1.setCharset,
  application = createCommonjsModule(function(module, exports) {
    var debug = src('express:application'),
      compileETag = utils$1.compileETag,
      compileQueryParser = utils$1.compileQueryParser,
      compileTrust = utils$1.compileTrust,
      deprecate = depd_1('express'),
    ...
    (app.init = function() {
      ...
      (app.defaultConfiguration = function() {
        ...
        this.enable('x-powered-by'),
          ...
          'production' === env && this.enable('view cache'),
      ...
      (app.render = function(name, options, callback) {
        ...
        if (
          ...
          opts._locals && utilsMerge(renderOptions, opts._locals),
          utilsMerge(renderOptions, opts),
          null == renderOptions.cache &&
  ...
  charset = preferredCharsets,
  preferredCharsets_1 = preferredCharsets,
  simpleCharsetRegExp = /^\s*([^\s;]+)\s*(?:;(.*))?$/;
...
function parseCharset(str, i) {
  ...
  var charset = match[1],
    q = 1;
  if (match[2])
    for (var params = match[2].split(';'), j = 0; j < params.length; j++) {
...
function getCharsetPriority(charset, accepted, index) {
  for (var priority = { o: -1, q: 0, s: 0 }, i = 0; i < accepted.length; i++) {
...
var encoding = preferredEncodings,
  preferredEncodings_1 = preferredEncodings,
...
function parseAcceptEncoding(accept) {
  ...
  return (
    hasIdentity || (accepts[j++] = { encoding: 'identity', q: minQuality, i }),
    (accepts.length = j),
    accepts
  );
}
...
var language = preferredLanguages,
  preferredLanguages_1 = preferredLanguages,
  simpleLanguageRegExp = /^\s*([^\s\-;]+)(?:-([^\s;]+))?\s*(?:;(.*))?$/;
...
function parseLanguage(str, i) {
  ...
  var q = 1;
  if (match[3])
    for (var params = match[3].split(';'), j = 0; j < params.length; j++) {
...
var mediaType = preferredMediaTypes,
  preferredMediaTypes_1 = preferredMediaTypes,
  simpleMediaTypeRegExp = /^\s*([^\s\/;]+)\/([^;\s]+)\s*(?:;(.*))?$/;
function parseAccept(accept) {
  for (
    var accepts = splitMediaTypes(accept), i = 0, j = 0;
    i < accepts.length;
    i++
  ) {
...
function parseMediaType(str, i) {
  ...
  if (match[3])
    for (
      var kvps = splitParameters(match[3]).map(splitKeyValuePair), j = 0;
      j < kvps.length;
      j++
    ) {
      var pair = kvps[j],
...
function quoteCount(string) {
  for (var count = 0, index = 0; -1 !== (index = string.indexOf('"', index)); )
    count++, index++;
  return count;
}
function splitKeyValuePair(str) {
  ...
  return (
    -1 === index
      ? (key = str)
      : ((key = str.substr(0, index)), (val = str.substr(index + 1))),
    [key, val]
  );
}
function splitMediaTypes(accept) {
  for (var accepts = accept.split(','), i = 1, j = 0; i < accepts.length; i++)
    quoteCount(accepts[j]) % 2 == 0
      ? (accepts[++j] = accepts[i])
      : (accepts[j] += ',' + accepts[i]);
...
function splitParameters(str) {
  for (
    var parameters = str.split(';'), i = 1, j = 0;
    i < parameters.length;
    i++
  )
    quoteCount(parameters[j]) % 2 == 0
...
function extToMime(type) {
  return -1 === type.indexOf('/') ? mimeTypes.lookup(type) : type;
}
...
(Accepts.prototype.type = Accepts.prototype.types = function(types_) {
  ...
  var mimes = types.map(extToMime),
    accepts = this.negotiator.mediaTypes(mimes.filter(validMime)),
    first = accepts[0];
  ...
  (Accepts.prototype.encoding = Accepts.prototype.encodings = function(
    ...
    return encodings && 0 !== encodings.length
      ? this.negotiator.encodings(encodings)[0] || !1
  ...
  (Accepts.prototype.charset = Accepts.prototype.charsets = function(
    ...
    return charsets && 0 !== charsets.length
      ? this.negotiator.charsets(charsets)[0] || !1
  ...
  (Accepts.prototype.lang = Accepts.prototype.langs = Accepts.prototype.language = Accepts.prototype.languages = function(
    ...
    return languages && 0 !== languages.length
      ? this.negotiator.languages(languages)[0] || !1
...
(req.get = req.header = function(name) {
  ...
  (req.range = function(size, options) {
    ...
    if (range) return rangeParser_1(size, range, options);
  }),
  ...
  defineGetter(req, 'xhr', function() {
    return (
      'xmlhttprequest' === (this.get('X-Requested-With') || '').toLowerCase()
    );
  });
var cookieSignature = createCommonjsModule(function(module, exports) {
  ...
  cookieSignature_1 = cookieSignature.sign,
  cookieSignature_2 = cookieSignature.unsign,
  parse_1$4 = parse$9,
  serialize_1 = serialize,
  decode$2 = decodeURIComponent,
  encode$1 = encodeURIComponent,
  pairSplitRegExp = /; */,
  ...
  for (
    ...
    if (!(eq_idx < 0)) {
      ...
      '"' == val[0] && (val = val.slice(1, -1)),
        null == obj[key] && (obj[key] = tryDecode(val, dec));
    }
  }
  return obj;
}
...
var cookie = { parse: parse_1$4, serialize: serialize_1 },
  vary_1 = vary,
  append_1 = append,
...
function append(header, field) {
  ...
  for (
    var fields = Array.isArray(field) ? field : parse$a(String(field)), j = 0;
    j < fields.length;
    j++
  )
  ...
  var val = header,
    vals = parse$a(header.toLowerCase());
  if (-1 !== fields.indexOf('*') || -1 !== vals.indexOf('*')) return '*';
  for (var i = 0; i < fields.length; i++) {
    var fld = fields[i].toLowerCase();
    -1 === vals.indexOf(fld) &&
      (vals.push(fld), (val = val ? val + ', ' + fields[i] : fields[i]));
  }
  return val;
}
function parse$a(header) {
  for (
    var end = 0, list = [], start = 0, i = 0, len = header.length;
    i < len;
    i++
  )
    switch (header.charCodeAt(i)) {
...
function vary(res, field) {
  ...
  var val = res.getHeader('Vary') || '',
    header = Array.isArray(val) ? val.join(', ') : String(val);
  (val = append(header, field)) && res.setHeader('Vary', val);
}
vary_1.append = append_1;
var Buffer$a = safeBuffer.Buffer,
  deprecate$3 = depd_1('express'),
  isAbsolute = utils$1.isAbsolute,
  sign = cookieSignature.sign,
  normalizeType$1 = utils$1.normalizeType,
  normalizeTypes = utils$1.normalizeTypes,
  setCharset = utils$1.setCharset,
  extname$2 = path$2.extname,
  mime$1 = send_1.mime,
  resolve$2 = path$2.resolve,
  ...
  file.on('directory', function() {
    ...
    options.headers &&
      file.on('headers', function(res) {
        for (
          var obj = options.headers, keys = Object.keys(obj), i = 0;
          i < keys.length;
          i++
        ) {
          var k = keys[i];
...
(res.status = function(code) {
    ...
    switch (
      ...
      case 'object':
        if (null === chunk) chunk = '';
          ...
          if (!Buffer$a.isBuffer(chunk)) return this.json(chunk);
  ...
  (res.json = function(obj) {
    ...
    var app = this.app,
      ...
      body = stringify$1(val, replacer, spaces, escape);
    return (
  ...
  (res.sendFile = function(path, options, callback) {
    ...
    sendfile(this, send_1(req, pathname, opts), opts, function(err) {
      return done
        ? done(err)
        : err && 'EISDIR' === err.code
        ? next()
  ...
  (res.sendfile = function(path, options, callback) {
    var done = callback,
      ...
      opts = options || {};
    'function' == typeof options && ((done = options), (opts = {})),
      sendfile(this, send_1(req, path, opts), opts, function(err) {
        return done
          ? done(err)
          : err && 'EISDIR' === err.code
          ? next()
  ...
  (res.sendfile = deprecate$3.function(
    res.sendfile,
  ...
  (res.download = function(path, filename, options, callback) {
    ...
    var headers = { 'Content-Disposition': contentDisposition_1(name || path) };
    if (opts && opts.headers)
      for (var keys = Object.keys(opts.headers), i = 0; i < keys.length; i++) {
        var key = keys[i];
        'content-disposition' !== key.toLowerCase() &&
  ...
  (res.contentType = res.type = function(type) {
    var ct = -1 === type.indexOf('/') ? mime$1.lookup(type) : type;
  ...
  (res.attachment = function(filename) {
    return (
      filename && this.type(extname$2(filename)),
  ...
  (res.cookie = function(name, value, options) {
    ...
    var val =
      'object' == typeof value ? 'j:' + JSON.stringify(value) : String(value);
    return (
      signed && (val = 's:' + sign(val, secret)),
      'maxAge' in opts &&
  ...
  (res.vary = function(field) {
    return !field || (Array.isArray(field) && !field.length)
      ? (deprecate$3('res.vary(): Provide a field name'), this)
      : (vary_1(this, field), this);
  }),
...
function serveStatic(root, options) {
  ...
  var opts = Object.create(options || null),
    fallthrough = !1 !== opts.fallthrough,
    redirect = !1 !== opts.redirect,
    setHeaders = opts.setHeaders;
  if (setHeaders && 'function' != typeof setHeaders)
  ...
  return function(req, res, next) {
    ...
    var forwardError = !fallthrough,
      originalUrl = parseurl_1.original(req),
      path = parseurl_1(req).pathname;
  ...
  return function(res) {
    if (this.hasTrailingSlash()) this.error(404);
      ...
      (originalUrl.path = null),
        (originalUrl.pathname = collapseLeadingSlashes$1(
          originalUrl.pathname + '/'
        ));
      var loc = encodeurl(url.format(originalUrl)),
        doc = createHtmlDocument$2(
          'Redirecting',
          'Redirecting to <a href="' +
            escapeHtml_1(loc) +
            '">' +
...
var express = createCommonjsModule(function(module, exports) {
    ...
    ((exports = module.exports = function() {
      ...
      return (
        mergeDescriptors(app, EventEmitter.prototype, !1),
        mergeDescriptors(app, application, !1),
  ...
  express_1 = express.application,
  express_2 = express.request,
  express_3 = express.response,
  express_4 = express.Route,
  express_5 = express.Router,
  express_6 = express.json,
  express_7 = express.query,
  express_8 = express.raw,
  express_9 = express.text,
  express_10 = express.urlencoded;
export default express;
export {
  express_4 as Route,
  express_5 as Router,
  express_1 as application,
  express_6 as json,
  express_7 as query,
  express_8 as raw,
  express_2 as request,
  express_3 as response,
  express_9 as text,
  express_10 as urlencoded
};
